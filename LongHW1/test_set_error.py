...
#this code contains the part with early stopping with smaller regularization lambda
import theano
from theano import *
...
with open(r'P:\Coursera\AM207\best_model.pkl', 'wb') as f:
    pickle.dump(classifier, f)

test_losses = [test_model(i)for i in range(n_test_batches)]
test_score = np.mean(test_losses)

print('test error is',test_score)

#0.082331730769230768
